...
// no active goal file. Callers can use errors.Is to distinguish this case
// (Phase 7 plan §3.7 graceful degradation, retained for Phase 11
// per-turn design — turn start can re-archive if the goal is stale).
