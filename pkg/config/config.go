...
type AgentDefaults struct {
	...
	MaxIterationsCap          int                `json:"max_iterations_cap,omitempty"     env:"PICOCLAW_AGENTS_DEFAULTS_MAX_ITERATIONS_CAP"` // Phase 10.1: restored for goal_progress self-extend.
